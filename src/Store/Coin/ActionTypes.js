...
export const FETCH_COIN_LIST_SUCCESS="FETCH_COIN_LIST_SUCCCES"
export const FETCH_COIN_LIST_FAILURE="FETCH_COIN_LIST_FAILURE"


export const FETCH_TOP_50_REQUEST = "FETCH_TOP_50_REQUEST";
export const FETCH_TOP_50_SUCCESS = "FETCH_TOP_50_SUCCESS";
export const FETCH_TOP_50_FAILURE = "FETCH_TOP_50_FAILURE";
