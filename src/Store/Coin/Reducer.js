import {
    FETCH_TOP_50_REQUEST,
    FETCH_TOP_50_SUCCESS,
    FETCH_TOP_50_FAILURE,
  ...
  const coinReducer = (state = initialState, action) => {
    switch (action.type) {
      ...
      case FETCH_COIN_DETAILS_SUCCESS:
        console.log('REDUCER', action.payload); // Verifica el payload
